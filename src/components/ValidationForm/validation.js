...
export const FormValidation = () => {
  ...
  const confirmPassChecker = (updatedInputVal) => {
    ...
    if (
      newPassValue === newConfirmPassValue &&
      newPassValue !== "" &&
      newConfirmPassValue !== ""
    ) {
  ...
  const passwordChecker = (updatedInputVal) => {
    ...
    setNewPassCheck((prevState) => {
      ...
      const allConditionsMet = Object.values(updatedNewPassCheck).every(
        (condition) => condition
      );
      setValidPassword((prevState) => ({
        ...prevState,
        validNewPass: allConditionsMet,
      }));
  ...
  const passwordStrength = () => {
    const { length, lowercase, uppercase, numeric, specialCharacter } =
      newPassCheck;
    const conditionsMet = [
      length,
      lowercase,
        ...
        <form action="#" className="formField">
          <div className="emailField">
            ...
            <FormInput
              ...
              onKeyDown={(e) =>
                handleKeyDown(e, document.getElementById("newPass"))
              }
            />
          ...
          <div className="passwordField">
            ...
            <InputSpanWrapper className="inputSpan">
              <FormInput
                ...
                onKeyDown={(e) =>
                  handleKeyDown(e, document.getElementById("confirmPass"))
                }
              />
              <EyeIconSpan
                onClick={PassToggle}
                $validPass={validPassword.validNewPass}
              >
                {newPass ? (
          ...
          <div className="confirmPassField">
            ...
            <InputSpanWrapper className="inputSpan">
              <FormInput
                ...
                onKeyDown={(e) =>
                  handleKeyDown(e, document.getElementById("submitButton"))
                }
              />
              <EyeIconSpan
                onClick={ConfirmPassToggle}
                $validPass={validPassword.validConfirmPass}
              >
                {confirmPass ? (
                  <FontAwesomeIcon icon={faEyeSlash} size="lg" />
                ) : (
          ...
          <PasswordStrengthSpan
            $strength={passwordStrength(newPassCheck)}
          ></PasswordStrengthSpan>
          <PasswordStrengthContent>
            {passwordStrength(newPassCheck)}
          </PasswordStrengthContent>
        </form>
        <PasswordChecker>
